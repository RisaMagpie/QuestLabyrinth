...
def create_database():
    try:
        ...
        print("actions_id table created")
        ...
        print("screenplay_for_state table created")
        ...
        print("actions_for_state table created")
        ...
        print("screenplay_id table created")
        ...
        print("user_inventory table created")
        ...
        print("user_state table created")
        ...
        print("possible_action_id_fk created")
        ...
        cur.execute('''ALTER TABLE actions_for_state 
                    ...
                    ON DELETE CASCADE ON UPDATE CASCADE;''')
        print("action_coordinates_id_fk created")
        ...
        cur.execute('''ALTER TABLE user_state 
                    ...
                    REFERENCES screenplay_for_state(coordinate_x,coordinate_y) 
                    ON DELETE CASCADE ON UPDATE CASCADE;''')
        print("user_coordinates_fk created")
        ...
        cur.execute('''ALTER TABLE screenplay_for_state 
                    ...
                    ON DELETE CASCADE ON UPDATE CASCADE;''')
        print("current_screenplay_part_id_fk created")
